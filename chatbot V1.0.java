...
else if(resp.equals("what time is it") || resp.equals("whats the time") || resp.equals("what is the time") || resp.contains("what time is it?") || resp.contains("whats the time?") || resp.contains("what is the time?")) {
System.out.print("\nbot--{      Current time: ");
